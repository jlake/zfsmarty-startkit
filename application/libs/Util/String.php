...
/**
 * •¶Žš—ñˆ—‹@”\
 * @author http://code.google.com/p/php-string/
 *
 */
class Lib_Util_String implements Iterator, ArrayAccess, Countable
{
    /**
     * Literal string.
     * @var string
    ...
    public function getEncoding()
    {
        if ($this->_encoding === null) {
            ...
            } else if (function_exists('utf8_compliant') && utf8_compliant($this->_string)) {
