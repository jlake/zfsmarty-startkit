...
class ZFDebug_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
            ...
            <script type="text/javascript" charset="utf-8">
                var ZFDebugLoad = function(){
                    if (typeof jQuery == "undefined") {
                        ...
                        setTimeout(ZFDebugCollapsed, 100);
                    } else {
                        ZFDebugCollapsed();
                    }
                };
                window.onload = ZFDebugLoad;
    ...
    protected function _output($html)
    {
        ...
        $response->setBody(preg_replace('/(<\/head\s*>)/i', $this->_headerOutput().'${1}', $response->getBody()));
